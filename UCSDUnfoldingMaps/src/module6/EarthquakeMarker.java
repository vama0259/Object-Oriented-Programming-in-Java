...
public abstract class EarthquakeMarker extends CommonMarker implements Comparable<EarthquakeMarker> 
{
	...
	public int compareTo(EarthquakeMarker marker) {
		//String curr = this.getStringProperty("magnitude");
		//String other = marker.getStringProperty("magnitude");
		//return(curr.compareTo(other));
		return(marker.getProperty("magnitude").toString().compareTo(this.getProperty("magnitude").toString()));
	}
	...
	public void drawMarker(PGraphics pg, float x, float y) {
		...
		if(this.getClicked()) {
			pg.noFill();
			pg.ellipse(x, y, (float) (0.25 *threatCircle()), (float) (0.25 *threatCircle()));
		}
	}
